        ...
        child: Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].description
                      : diseaseInfoa[index].description,
                  Theme.of(context).colorScheme.primary),
              divider(),
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].causes
                      : diseaseInfoa[index].causes,
                  Theme.of(context).colorScheme.primary),
              divider(),
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].symptoms
                      : diseaseInfoa[index].symptoms,
                  Theme.of(context).colorScheme.primary),
              divider(),
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].diagnosis
                      : diseaseInfoa[index].diagnosis,
                  Theme.of(context).colorScheme.primary),
              divider(),
              sectionTitle(
                  AppLocalizations.of(context).translate("treatmentDuration"),
                  Theme.of(context).colorScheme.primary),
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].treatmentDuration
                      : diseaseInfoa[index].treatmentDuration,
                  Theme.of(context).colorScheme.primary),
              divider(),
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].medication
                      : diseaseInfoa[index].medication,
                  Theme.of(context).colorScheme.primary),
              divider(),
              sectionTitle(
                  AppLocalizations.of(context)
                      .translate("alternativeTreatments"),
                  Theme.of(context).colorScheme.primary),
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].alternativeTreatments
                      : diseaseInfoa[index].alternativeTreatments,
                  Theme.of(context).colorScheme.primary),
              divider(),
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].diet
                      : diseaseInfoa[index].diet,
                  Theme.of(context).colorScheme.primary),
              divider(),
              sectionTitle(
                  AppLocalizations.of(context).translate("homeRemedies"),
                  Theme.of(context).colorScheme.primary),
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].homeRemedies
                      : diseaseInfoa[index].homeRemedies,
                  Theme.of(context).colorScheme.primary),
              divider(),
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].advice
                      : diseaseInfoa[index].advice,
                  Theme.of(context).colorScheme.primary),
              divider(),
              sectionTitle(
                  AppLocalizations.of(context).translate("atRiskGroups"),
                  Theme.of(context).colorScheme.primary),
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].atRiskGroups
                      : diseaseInfoa[index].atRiskGroups,
                  Theme.of(context).colorScheme.primary),
              divider(),
              sectionTitle(
                  AppLocalizations.of(context).translate("complications"),
                  Theme.of(context).colorScheme.primary),
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].complications
                      : diseaseInfoa[index].complications,
                  Theme.of(context).colorScheme.primary),
              divider(),
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].prevention
                      : diseaseInfoa[index].prevention,
                  Theme.of(context).colorScheme.primary),
              divider(),
              ...
              sectionContent(
                  Provider.of<LanguageProvider>(context).isEnglish
                      ? diseaseInfo[index].references
                      : diseaseInfoa[index].references,
                  Theme.of(context).colorScheme.primary),
              divider(),
