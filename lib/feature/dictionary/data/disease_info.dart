...
List<DiseaseInfoModel> diseaseInfo = [
  ...
  DiseaseInfoModel(
    ...
    medication: 'Antibiotics, Antifungal drugs, Antifungal drugs, IV fluids, Oxygen therapy',
...
List<DiseaseInfoModel> diseaseInfoa = [
  DiseaseInfoModel(
    ...
    medication: 'كريم مضاد للفطريات، فلوكونازول، تيربينافين، كلوتريمازول، كيتوكونازول',
    causes: 'تسببها فطريات مثل الجلديات، الخمائر، أو العفن. شائعة في الأجواء الدافئة والرطبة.',
    symptoms: 'حكة الجلد، احمرار، طفح جلدي، تقشر الجلد',
    prevention: 'الحفاظ على النظافة، تجنب مشاركة الأدوات الشخصية، الحفاظ على الجلد جافًا',
    ...
    references: 'منظمة الصحة العالمية (WHO)، مايو كلينك، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Fungalinfection.png',
    lifestyle: 'الحفاظ على النظافة الشخصية، ارتداء ملابس قطنية، تجنب المشي حافيًا في الأماكن العامة.',
    doctorSpecialization: 'أمراض جلدية',
  ),
  DiseaseInfoModel(
    disease: 'حساسية',
    description: 'الحساسية هي رد فعل جهاز المناعة تجاه مادة في البيئة.',
    diet: 'حمية الإقصاء، أطعمة غنية بأوميجا-3، أطعمة غنية بفيتامين سي، أطعمة غنية بالكيرسيتين، بروبيوتيك',
    medication: 'مضادات الهيستامين، مزيلات الاحتقان، إبينفرين، كورتيكوستيرويدات، علاج مناعي',
    causes: 'تسببها مسببات الحساسية مثل حبوب اللقاح، الغبار، وبر الحيوانات، أو أطعمة معينة.',
    symptoms: 'عطس، سيلان الأنف، حكة العيون، طفح جلدي، تورم',
    prevention: 'تجنب مسببات الحساسية، استخدام أجهزة تنقية الهواء، إغلاق النوافذ في مواسم حبوب اللقاح',
    ...
    references: 'الأكاديمية الأمريكية للحساسية والربو والمناعة (AAAAI)، مايو كلينك',
    image: 'assest/diease_imges/allergy.png',
    lifestyle: 'تجنب مسببات الحساسية، حافظ على نظافة المسكن، استخدم فراش مضاد للحساسية.',
    doctorSpecialization: 'أخصائي حساسية/مناعة',
  ),
  DiseaseInfoModel(
    disease: 'ارتجاع معدي مريئي (GERD)',
    description: 'الارتجاع المعدي المريئي هو اضطراب هضمي يؤثر على العضلة العاصرة السفلية للمريء.',
    diet: 'حمية قليلة الحموضة، أطعمة غنية بالألياف، زنجبيل، عرق سوس، عصير صبار',
    medication: 'مثبطات مضخة البروتون، حاصرات H2، مضادات الحموضة، محفزات الحركة الدودية، مضادات حيوية',
    causes: 'تسببها ضعف العضلة العاصرة المريئية، السمنة، أو فتق الحجاب الحاجز.',
    symptoms: 'حرقة المعدة، قلس، ألم صدر، صعوبة بلع',
    prevention: 'تجنب الأطعمة الحارة والدهنية، تناول وجبات صغيرة، تجنب الاستلقاء بعد الأكل',
    diagnosis: 'تنظير داخلي، مراقبة الحموضة، اختبار ابتلاع الباريوم',
    complications: 'التهاب المريء، مريء باريت، سرطان المريء',
    treatmentDuration: 'تغييرات نمط الحياة والأدوية يمكنها التحكم بالأعراض على المدى الطويل',
    advice: 'ارفع رأس السرير، تجنب التدخين، خفف الوزن إذا كنت تعاني من زيادة الوزن',
    homeRemedies: 'اشرب شاي البابونج، امضغ علكة لزيادة اللعاب، تجنب الكافيين',
    atRiskGroups: 'أصحاب الوزن الزائد، الحوامل، المدخنون',
    alternativeTreatments: 'الوخز بالإبر، العلاجات العشبية مثل الدردار الزلق، مكملات الميلاتونين',
    references: 'المعهد الوطني للسكري وأمراض الجهاز الهضمي والكلى (NIDDK)، مايو كلينك',
    image: 'assest/diease_imges/gastroesophagealrefluxdisease.png',
    lifestyle: 'تجنب الوجبات الكبيرة، كل ببطء، تجنب الاستلقاء مباشرة بعد الأكل.',
    doctorSpecialization: 'أخصائي جهاز هضمي',
  ),
  DiseaseInfoModel(
    disease: 'ركود صفراوي مزمن',
    description: 'الركود الصفراوي المزمن هو حالة تنخفض فيها تدفق الصفراء من الكبد لفترة ممتدة.',
    diet: 'حمية قليلة الدهون، حمية غنية بالألياف، بروتينات خفيفة، حبوب كاملة، فواكه وخضروات طازجة',
    medication: 'حمض أورسوديوكسيكوليك، كوليستيرامين، ميثوتريكسات، كورتيكوستيرويدات، زراعة كبد',
    causes: 'تسببها أمراض الكبد مثل التهاب الأقنية الصفراوية الأولي أو انسداد القناة الصفراوية.',
    symptoms: 'يرقان، حكة، إعياء، بول داكن، براز فاتح',
    prevention: 'تجنب الكحول، حافظ على حمية صحية، احصل على تطعيم ضد التهاب الكبد',
    diagnosis: 'فحوصات الدم، اختبارات وظائف الكبد، دراسات تصويرية مثل الموجات فوق الصوتية أو الرنين المغناطيسي',
    complications: 'فشل كبدي، تليف الكبد، سوء تغذية',
    treatmentDuration: 'إدارة طويلة المدى؛ قد تتطلب علاج مدى الحياة',
    advice: 'اتبع حمية قليلة الدهون، تجنب الكحول، تناول الأدوية الموصوفة بانتظام',
    homeRemedies: 'اشرب الكثير من الماء، تناول وجبات صغيرة متكررة، تجنب الأطعمة الدهنية',
    ...
    references: 'مؤسسة الكبد الأمريكية، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Jaundice.png',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية مضادات الهيستامين، أطعمة غنية بأوميجا-3، أطعمة غنية بفيتامين سي، أطعمة غنية بالكيرسيتين، بروبيوتيك',
    medication: 'مضادات الهيستامين، إبينفرين، كورتيكوستيرويدات، مضادات حيوية، كريم مضاد للفطريات',
    ...
    references: 'الأكاديمية الأمريكية للحساسية والربو والمناعة (AAAAI)، مايو كلينك',
    image: 'assest/diease_imges/drugreaction.png',
    lifestyle: 'تجنب الأدوية المثيرة للتفاعلات، أخبر مقدمي الرعاية الصحية عن الحساسيات المعروفة.',
    doctorSpecialization: 'أخصائي حساسية/مناعة',
  ),
   DiseaseInfoModel(
    disease: 'قرحة المعدة',
    description: 'قرحة المعدة هي تقرحات تتطور على البطانة الداخلية للمعدة والأمعاء الدقيقة.',
    diet: 'حمية قليلة الحموضة، أطعمة غنية بالألياف، زنجبيل، عرق سوس، عصير صبار',
    medication: 'مضادات حيوية، مثبطات مضخة البروتون، حاصرات H2، مضادات الحموضة، عوامل واقية للخلايا',
    causes: 'تسببها عدوى بكتيريا الملوية البوابية أو الاستخدام طويل الأمد للأدوية المضادة للالتهاب.',
    symptoms: 'ألم البطن، انتفاخ، غثيان، قيء، فقدان الشهية',
    prevention: 'تجنب الأدوية المضادة للالتهاب، الحد من الكحول، الإقلاع عن التدخين، إدارة الإجهاد',
    ...
    advice: 'تناول وجبات صغيرة متكررة، تجنب الأطعمة الحارة، التزم بالأدوية الموصوفة',
    homeRemedies: 'اشرب عصير الملفوف، تناول الموز، استهلك العسل',
    atRiskGroups: 'المصابون بعدوى الملوية البوابية، مستخدمو الأدوية المضادة للالتهاب بكثرة، المدخنون',
  ...
  DiseaseInfoModel(
    disease: 'الإيدز (AIDS)',
    description: 'متلازمة نقص المناعة المكتسب (الإيدز) مرض يسببه فيروس HIV ويضعف الجهاز المناعي.',
    diet: 'حمية متوازنة، أطعمة غنية بالبروتين، فواكه وخضروات، حبوب كاملة، دهون صحية',
    medication: 'أدوية مضادة للفيروسات القهقرية، مثبطات البروتياز، مثبطات الإنزيم المدمج، مثبطات الدخول، مثبطات الاندماج',
    ...
    treatmentDuration: 'علاج مدى الحياة بالعلاج المضاد للفيروسات القهقرية (ART)',
    ...
    atRiskGroups: 'شركاء الجنس غير المحميين، متعاطو المخدرات بالحقن، العاملون في الرعاية الصحية',
    ...
    image: 'assest/diease_imges/Acne.png',
    lifestyle: 'ممارسة الجنس الآمن، تجنب مشاركة الإبر، حافظ على حمية صحية وروتين تمارين.',
    doctorSpecialization: 'أخصائي أمراض معدية',
  ),
  DiseaseInfoModel(
    disease: 'السكري',
    description: 'السكري حالة مزمنة تؤثر على كيفية معالجة الجسم لسكر الدم.',
    diet: 'حمية منخفضة المؤشر الجلايسيمي، أطعمة غنية بالألياف، بروتينات خفيفة، دهون صحية، منتجات ألبان قليلة الدسم',
    medication: 'أنسولين، ميتفورمين، سلفونيل يوريا، مثبطات DPP-4، ناهضات مستقبلات GLP-1',
    ...
    diagnosis: 'فحص سكر الدم الصائم، اختبار الهيموغلوبين A1c، اختبار تحمل الجلوكوز الفموي',
    ...
    references: 'الجمعية الأمريكية للسكري (ADA)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/diabetes.png',
  ...
  DiseaseInfoModel(
    ...
    description: 'التهاب المعدة والأمعاء هو التهاب في المعدة والأمعاء، عادةً بسبب فيروس أو بكتيريا.',
    diet: 'حمية لطيفة، موز، أرز، صلصة التفاح، توست',
    medication: 'مضادات حيوية، أدوية مضادة للقيء، أدوية مضادة للإسهال، سوائل وريدية، بروبيوتيك',
    causes: 'تسببها التهابات فيروسية أو بكتيرية، طعام أو ماء ملوث.',
    symptoms: 'إسهال، قيء، ألم بطني، حمى، جفاف',
    prevention: 'اغسل اليدين بانتظام، تجنب الطعام والماء الملوثين، حافظ على النظافة الجيدة',
    ...
    homeRemedies: 'اشرب محلول معالجة الجفاف، تناول البطاطس المسلوقة، استهلك شاي الزنجبيل',
    atRiskGroups: 'الأطفال، كبار السن، أصحاب المناعة الضعيفة',
    alternativeTreatments: 'بروبيوتيك، مكملات الزنجبيل، شاي النعناع',
    references: 'منظمة الصحة العالمية (WHO)، مايو كلينك، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/CommonCold.png',
    lifestyle: 'حافظ على النظافة الجيدة، تجنب الطعام والماء الملوثين، حافظ على الترطيب.',
    doctorSpecialization: 'أخصائي جهاز هضمي',
  ),
  DiseaseInfoModel(
    disease: 'الربو القصبي',
    description: 'الربو القصبي حالة تنفسية تتميز بالتهاب الممرات الهوائية.',
    diet: 'حمية مضادة للالتهاب، أطعمة غنية بأوميجا-3، فواكه وخضروات، حبوب كاملة، بروتينات خفيفة',
    medication: 'موسعات قصبية، كورتيكوستيرويدات مستنشقة، معدلات الليكوترين، مثبتات الخلايا البدينة، مضادات الكولين',
    causes: 'تسببها عوامل وراثية، محفزات بيئية، أو حساسيات.',
    symptoms: 'صفير، ضيق تنفس، ضيق صدر، سعال',
    prevention: 'تجنب المحفزات، استخدم البخاخات حسب الوصف، حافظ على نمط حياة صحي',
    diagnosis: 'قياس التنفس، اختبار ذروة الجريان، اختبار حساسية',
    complications: 'نوبات ربو شديدة، فشل تنفسي، مرض الانسداد الرئوي المزمن (COPD)',
    ...
    references: 'الجمعية الأمريكية للرئة، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/BronchialAsthma.png',
    lifestyle: 'تجنب مسببات الحساسية، استخدم أجهزة تنقية الهواء، تمرن بانتظام لكن تجنب الإجهاد المفرط.',
    doctorSpecialization: 'أخصائي رئة',
  ),
   DiseaseInfoModel(
    disease: 'ارتفاع ضغط الدم',
    description: 'ارتفاع ضغط الدم هو حالة شائعة تؤثر على الشرايين وتزيد من خطر الإصابة بأمراض القلب.',
    diet: 'حمية DASH، أطعمة قليلة الصوديوم، فواكه وخضروات، حبوب كاملة، بروتينات خفيفة',
    medication: 'أدوية خافضة للضغط، مدرات البول، حاصرات بيتا، مثبطات ACE، حاصرات قنوات الكالسيوم',
    ...
    atRiskGroups: 'أصحاب الوزن الزائد، كبار السن، أصحاب التاريخ العائلي لارتفاع الضغط',
    alternativeTreatments: 'مكملات CoQ10، أوميجا-3، التأمل',
    references: 'جمعية القلب الأمريكية (AHA)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Hypertension.png',
  ...
  DiseaseInfoModel(
    ...
    description: 'الصداع النصفي نوع من الصداع يسبب ألمًا شديدًا وحساسية للضوء والصوت.',
    diet: 'حمية الصداع النصفي، حمية منخفضة التيرامين، انسحاب الكافيين، ترطيب، أطعمة غنية بالمغنيسيوم',
    medication: 'مسكنات الألم، التريبتانات، مشتقات الإرغوتامين، أدوية وقائية، التغذية الحيوية الراجعة',
    ...
    diagnosis: 'تاريخ طبي، فحص جسدي، تصوير بالرنين المغناطيسي أو الأشعة المقطعية',
    complications: 'صداع نصفي مزمن، حالة الصداع النصفي المستمرة، صداع فرط استخدام الأدوية',
    treatmentDuration: 'يختلف حسب الشدة؛ قد يكون مدى الحياة للحالات المزمنة',
    advice: 'احتفظ بمذكرات الصداع النصفي، تجنب المحفزات المعروفة، التزم بالأدوية الموصوفة',
    homeRemedies: 'ضع كمادات باردة، اشرب شاي الزنجبيل، مارس تقنيات الاسترخاء',
    atRiskGroups: 'النساء، أصحاب التاريخ العائلي للصداع النصفي، أصحاب الاختلالات الهرمونية',
    alternativeTreatments: 'الوخز بالإبر، مكملات البترور، الريبوفلافين (فيتامين B2)',
    references: 'مؤسسة الصداع النصفي الأمريكية، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Migraine.png',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية التهاب المفاصل، حمية مضادة للالتهاب، أطعمة غنية بأوميجا-3، فواكه وخضروات، حبوب كاملة',
    medication: 'مسكنات الألم، مرخيات العضلات، علاج طبيعي، دعامات الرقبة، كورتيكوستيرويدات',
    ...
    atRiskGroups: 'كبار السن، أصحاب الوضعيات السيئة، أصحاب إجهاد الرقبة المتكرر',
    alternativeTreatments: 'العلاج بتقويم العمود الفقري، الوخز بالإبر، مكملات الكركم',
    references: 'الأكاديمية الأمريكية لجراحي العظام (AAOS)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Cervicalspondylosis.png',
  ...
  DiseaseInfoModel(
    ...
    description: 'الشلل (النزيف الدماغي) هو فقدان وظيفة العضلات بسبب نزيف في الدماغ.',
    diet: 'حمية صحة القلب، أطعمة قليلة الصوديوم، فواكه وخضروات، حبوب كاملة، بروتينات خفيفة',
    medication: 'مميعات الدم، أدوية إذابة الجلطات، مضادات الاختلاج، علاج طبيعي، علاج وظيفي',
    ...
    advice: 'اتبع خطة إعادة التأهيل، التزم بالأدوية الموصوفة، حافظ على نمط حياة صحي',
    homeRemedies: 'مارس تمارين العلاج الطبيعي، تناول حمية متوازنة، حافظ على الترطيب',
    atRiskGroups: 'أصحاب ضغط الدم المرتفع، المدخنون، أصحاب تاريخ السكتة الدماغية',
    alternativeTreatments: 'الوخز بالإبر، علاجات عشبية مثل الجنكة بيلوبا، التأمل',
    references: 'جمعية السكتة الدماغية الأمريكية، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Hypertension.png',
  ...
  DiseaseInfoModel(
    disease: 'اليرقان',
    description: 'اليرقان هو اصفرار الجلد والعينين، وغالبًا ما يشير إلى مشاكل في الكبد.',
    diet: 'حمية صحة الكبد، حمية قليلة الدهون، فواكه وخضروات، حبوب كاملة، بروتينات خفيفة',
    medication: 'سوائل وريدية، نقل دم، زراعة كبد، أدوية للحكة، أدوية مضادة للفيروسات',
    ...
    diet: 'حمية الملاريا، ترطيب، حمية عالية السعرات، أطعمة لطيفة، محاليل معالجة الجفاف',
    medication: 'أدوية مضادة للملاريا، خافضات الحرارة، أدوية مضادة للقيء، سوائل وريدية، نقل دم',
    causes: 'تسببها طفيليات البلازموديوم المنقولة عبر لدغات البعوض.',
    symptoms: 'حمى، قشعريرة، صداع، غثيان، قيء',
    prevention: 'استخدم الناموسيات، طارد الحشرات، تناول أدوية الوقاية من الملاريا',
    ...
    homeRemedies: 'اشرب الكثير من السوائل، تناول وجبات خفيفة، استخدم كمادات باردة',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية جدري الماء، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    medication: 'أدوية مضادة للفيروسات، مسكنات الألم، سوائل وريدية، نقل دم، نقل صفائح دموية',
    ...
    references: 'مراكز مكافحة الأمراض (CDC)، مايو كلينك، منظمة الصحة العالمية (WHO)',
    image: 'assest/diease_imges/Chickenpox.png',
    lifestyle: 'حافظ على النظافة الجيدة، تجنب الاحتكاك بالمصابين، احصل على التطعيم.',
    doctorSpecialization: 'طبيب أطفال أو أخصائي أمراض معدية',
  ),
  DiseaseInfoModel(
    disease: 'حمى الضنك',
    description: 'حمى الضنك عدوى فيروسية ينقلها البعوض وتسبب أعراضًا شبيهة بالإنفلونزا.',
    diet: 'حمية الضنك، ترطيب، حمية عالية السعرات، أطعمة لطيفة، أطعمة غنية بالبروتين',
    medication: 'مضادات حيوية، خافضات الحرارة، مسكنات، سوائل وريدية، كورتيكوستيرويدات',
    ...
    homeRemedies: 'اشرب عصير أوراق البابايا، تناول ماء جوز الهند، تناول وجبات خفيفة',
    ...
    references: 'منظمة الصحة العالمية (WHO)، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Dengue.jpeg',
    lifestyle: 'تجنب لدغات البعوض، استخدم طارد الحشرات، تخلص من المياه الراكدة.',
    doctorSpecialization: 'أخصائي أمراض معدية',
  ),
  DiseaseInfoModel(
    disease: 'التيفوئيد',
    description: 'التيفوئيد عدوى بكتيرية قد تسبب حمى شديدة وأعراضًا معوية.',
    diet: 'حمية التيفوئيد، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    ...
    prevention: 'احصل على التطعيم، حافظ على النظافة، تجنب الطعام والماء الملوثين',
    ...
    atRiskGroups: 'المسافرون إلى المناطق الموبوءة، أصحاب النظافة السيئة، الأطفال',
    alternativeTreatments: 'مكملات الثوم، كركم، بروبيوتيك',
    references: 'منظمة الصحة العالمية (WHO)، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Typhoid.png',
    lifestyle: 'مارس النظافة الجيدة، تجنب الطعام والماء الملوثين، احصل على التطعيم.',
    doctorSpecialization: 'أخصائي أمراض معدية',
  ),
  DiseaseInfoModel(
    disease: 'التهاب الكبد أ',
    description: 'التهاب الكبد أ مرض فيروسي يصيب الكبد.',
    diet: 'حمية التهاب الكبد أ، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    medication: 'تطعيم، أدوية مضادة للفيروسات، سوائل وريدية، نقل دم، زراعة كبد',
    ...
    homeRemedies: 'اشرب الكثير من الماء، تناول وجبات صغيرة متكررة، استهلك شاي الزنجبيل',
    atRiskGroups: 'المسافرون إلى المناطق الموبوءة، أصحاب النظافة السيئة، الأطفال',
    alternativeTreatments: 'مكملات حليب الشوك، كركم، شاي جذور الهندباء',
    references: 'منظمة الصحة العالمية (WHO)، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Jaundice.png',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية التهاب الكبد ب، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    medication: 'أدوية مضادة للفيروسات، سوائل وريدية، نقل دم، نقل صفائح دموية، زراعة كبد',
    ...
    advice: 'تناول الأدوية المضادة للفيروسات حسب الوصف، تجنب الكحول، حافظ على حمية صحية',
    homeRemedies: 'اشرب الكثير من الماء، تناول وجبات صغيرة متكررة، استهلك شاي الزنجبيل',
    atRiskGroups: 'العاملون في الرعاية الصحية، متعاطو المخدرات بالحقن، أصحاب الشركاء المتعددين',
    alternativeTreatments: 'مكملات حليب الشوك، كركم، شاي جذور الهندباء',
    references: 'منظمة الصحة العالمية (WHO)، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Jaundice.png',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية التهاب الكبد ج، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    medication: 'أدوية مضادة للفيروسات، سوائل وريدية، نقل دم، نقل صفائح دموية، زراعة كبد',
    ...
    advice: 'تناول الأدوية المضادة للفيروسات حسب الوصف، تجنب الكحول، حافظ على حمية صحية',
    homeRemedies: 'اشرب الكثير من الماء، تناول وجبات صغيرة متكررة، استهلك شاي الزنجبيل',
    atRiskGroups: 'متعاطو المخدرات بالحقن، أصحاب تاريخ نقل الدم، العاملون في الرعاية الصحية',
    alternativeTreatments: 'مكملات حليب الشوك، كركم، شاي جذور الهندباء',
    references: 'منظمة الصحة العالمية (WHO)، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Jaundice.png',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية التهاب الكبد د، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    medication: 'أدوية مضادة للفيروسات، سوائل وريدية، نقل دم، نقل صفائح دموية، زراعة كبد',
    causes: 'يسببها فيروس التهاب الكبد د (HDV)، الذي يحتاج لفيروس التهاب الكبد ب للتكاثر.',
    symptoms: 'إعياء، غثيان، ألم بطني، يرقان، بول داكن',
    prevention: 'احصل على تطعيم التهاب الكبد ب، تجنب مشاركة الإبر، مارس الجنس الآمن',
    diagnosis: 'فحوصات الدم، اختبارات وظائف الكبد، مصلية الفيروسات',
    complications: 'فشل كبدي، تليف الكبد، سرطان الكبد',
    treatmentDuration: 'إدارة طويلة المدى بالعلاج المضاد للفيروسات',
    advice: 'تناول الأدوية المضادة للفيروسات حسب الوصف، تجنب الكحول، حافظ على حمية صحية',
    homeRemedies: 'اشرب الكثير من الماء، تناول وجبات صغيرة متكررة، استهلك شاي الزنجبيل',
    atRiskGroups: 'المصابون بالتهاب الكبد ب، متعاطو المخدرات بالحقن، أصحاب الشركاء المتعددين',
    alternativeTreatments: 'مكملات حليب الشوك، كركم، شاي جذور الهندباء',
    references: 'منظمة الصحة العالمية (WHO)، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Jaundice.png',
    lifestyle: 'احصل على تطعيم التهاب الكبد ب، تجنب مشاركة الإبر، مارس الجنس الآمن.',
    doctorSpecialization: 'أخصائي كبد',
  ),
  DiseaseInfoModel(
    disease: 'التهاب الكبد هـ',
    description: 'التهاب الكبد هـ عدوى فيروسية تسبب التهاب الكبد.',
    diet: 'حمية التهاب الكبد هـ، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    medication: 'إيقاف الكحول، كورتيكوستيرويدات، سوائل وريدية، زراعة كبد، دعم غذائي',
    causes: 'يسببها فيروس التهاب الكبد هـ (HEV)، عادة عبر ماء ملوث.',
    symptoms: 'إعياء، غثيان، ألم بطني، يرقان، بول داكن',
    prevention: 'تجنب الماء الملوث، حافظ على النظافة، احصل على التطعيم إذا كان متاحًا',
    diagnosis: 'فحوصات الدم، اختبارات وظائف الكبد، مصلية الفيروسات',
    complications: 'فشل كبدي، ركود صفراوي، التهاب كبد متكرر',
    treatmentDuration: '2-6 أسبوع مع العناية المناسبة والترطيب',
    advice: 'ارتاح، حافظ على الترطيب، تجنب الكحول',
    homeRemedies: 'اشرب الكثير من الماء، تناول وجبات صغيرة متكررة، استهلك شاي الزنجبيل',
    atRiskGroups: 'المسافرون إلى المناطق الموبوءة، الحوامل، أصحاب النظافة السيئة',
    alternativeTreatments: 'مكملات حليب الشوك، كركم، شاي جذور الهندباء',
    references: 'منظمة الصحة العالمية (WHO)، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Jaundice.png',
    lifestyle: 'تجنب الماء الملوث، حافظ على النظافة، احصل على التطعيم إذا كان متاحًا.',
    doctorSpecialization: 'أخصائي كبد',
  ),
  DiseaseInfoModel(
    ...
    advice: 'توقف عن شرب الكحول، اتبع حمية صحية، تناول الأدوية الموصوفة بانتظام',
    homeRemedies: 'اشرب الكثير من الماء، تناول وجبات صغيرة متكررة، تجنب الأطعمة الدهنية',
    atRiskGroups: 'شاربو الكحول بكثرة، أصحاب تاريخ أمراض الكبد، أصحاب التغذية السيئة',
    alternativeTreatments: 'مكملات حليب الشوك، كركم، شاي جذور الهندباء',
    references: 'مؤسسة الكبد الأمريكية، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Jaundice.png',
    lifestyle: 'تجنب الكحول، حافظ على حمية صحية، تمرن بانتظام.',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية السل، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    medication: 'خافضات الحرارة، مزيلات الاحتقان، مثبطات السعال، مضادات الهيستامين، مسكنات الألم',
    causes: 'يسببها بكتيريا المتفطرة السلية.',
    symptoms: 'سعال مستمر، حمى، تعرق ليلي، فقدان وزن، إعياء',
    prevention: 'احصل على التطعيم، تجنب الاتصال الوثيق بالمصابين، حافظ على النظافة',
    ...
    homeRemedies: 'اشرب الكثير من السوائل، تناول حمية متوازنة، مارس تمارين التنفس',
    atRiskGroups: 'أصحاب المناعة الضعيفة، العاملون في الرعاية الصحية، سكان الأماكن المزدحمة',
    alternativeTreatments: 'مكملات الثوم، كركم، فيتامين د',
    references: 'منظمة الصحة العالمية (WHO)، مراكز مكافحة الأمراض (CDC)',
    image: 'assest/diease_imges/Tuberculosis.png',
    lifestyle: 'تجنب الاتصال الوثيق بالمصابين، حافظ على النظافة، احصل على التطعيم.',
  ...
  DiseaseInfoModel(
    ...
    medication: 'مضادات حيوية، أدوية مضادة للفطريات، أدوية مضادة للفطريات، سوائل وريدية، أكسجين',
    causes: 'تسببها فيروسات مثل الفيروس الأنفي أو الفيروس التاجي.',
    symptoms: 'سيلان الأنف، التهاب الحلق، سعال، عطس، حمى خفيفة',
    prevention: 'اغسل يديك بانتظام، تجنب الاتصال الوثيق بالمرضى، حافظ على النظافة',
    diagnosis: 'فحص جسدي، تقييم الأعراض',
    complications: 'التهابات الجيوب الأنفية، التهابات الأذن، التهاب الشعب الهوائية',
    treatmentDuration: '7-10 أيام مع الراحة والترطيب المناسبين',
    advice: 'حافظ على الترطيب، ارتاح، تجنب التدخين',
    homeRemedies: 'اشرب سوائل دافئة، استخدم بخاخ محلول ملحي، استهلك العسل والليمون',
    atRiskGroups: 'الأطفال، كبار السن، أصحاب المناعة الضعيفة',
    alternativeTreatments: 'إشنسا، مكملات الزنك، فيتامين سي',
    references: 'مراكز مكافحة الأمراض (CDC)، مايو كلينك، منظمة الصحة العالمية (WHO)',
    image: 'assest/diease_imges/CommonCold.png',
    lifestyle: 'اغسل يديك بانتظام، تجنب الاتصال الوثيق بالمرضى، حافظ على النظافة.',
    doctorSpecialization: 'طبيب عام',
  ),
  DiseaseInfoModel(
    disease: 'الالتهاب الرئوي',
    description: 'الالتهاب الرئوي حالة التهابية تصيب الأكياس الهوائية في الرئتين.',
    diet: 'حمية الالتهاب الرئوي، حمية عالية السعرات، أطعمة لطيفة، ترطيب، أطعمة غنية بالبروتين',
    medication: 'ملينات، مسكنات الألم، حمامات دافئة وباردة، حماية المفاصل، علاج طبيعي',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية البواسير، حمية غنية بالألياف، ترطيب، حمامات دافئة، ملينات البراز',
    medication: 'نيتروجليسرين، أسبرين، حاصرات بيتا، حاصرات قنوات الكالسيوم، أدوية إذابة الجلطات',
    causes: 'تسببها زيادة الضغط في أوردة المستقيم بسبب الإجهاد أو الحمل.',
    symptoms: 'ألم، حكة، نزيف، تورم حول الشرج',
    prevention: 'تجنب الإجهاد أثناء التبرز، تناول حمية غنية بالألياف، حافظ على الترطيب',
    ...
    advice: 'تجنب الجلوس لفترات طويلة، حافظ على النظافة، تناول حمية غنية بالألياف',
    ...
    references: 'الجمعية الأمريكية لجراحي القولون والمستقيم (ASCRS)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/DimorphicHemorrhoids.png',
    lifestyle: 'تجنب الإجهاد أثناء التبرز، تناول حمية غنية بالألياف، حافظ على الترطيب.',
    doctorSpecialization: 'أخصائي شرج ومستقيم',
  ),
  DiseaseInfoModel(
    disease: 'النوبة القلبية',
    description: 'النوبة القلبية هي انخفاض مفاجئ وحاد في تدفق الدم إلى عضلة القلب.',
    diet: 'حمية صحة القلب، أطعمة قليلة الصوديوم، فواكه وخضروات، حبوب كاملة، بروتينات خفيفة',
    medication: 'جوارب ضاغطة، تمارين، رفع الساقين، علاج بالتصلب، علاجات بالليزر',
    ...
    advice: 'تناول الأدوية حسب الوصف، اتبع حمية صحية للقلب، مارس الرياضة بانتظام',
    homeRemedies: 'مارس إدارة الإجهاد، استهلك أطعمة غنية بأوميجا-3، اشرب الشاي الأخضر',
    atRiskGroups: 'أصحاب ضغط الدم المرتفع، المدخنون، أصحاب التاريخ العائلي لأمراض القلب',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية الدوالي، حمية غنية بالألياف، فواكه وخضروات، حبوب كاملة، أطعمة قليلة الصوديوم',
    medication: 'ليفوثيروكسين، أدوية مضادة للغدة الدرقية، حاصرات بيتا، اليود المشع، جراحة الغدة الدرقية',
    ...
    alternativeTreatments: 'مكملات كستناء الحصان، العرعر الشائك، فلافونويدات',
    references: 'الجمعية الأمريكية لأمراض الدم (ASH)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/VaricoseVeins.png',
  ...
  DiseaseInfoModel(
    ...
    description: 'قصور الغدة الدرقية حالة لا تنتج فيها الغدة الدرقية ما يكفي من هرمونات الغدة الدرقية.',
    diet: 'حمية قصور الغدة الدرقية، أطعمة غنية باليود، أطعمة غنية بالسيلينيوم، فواكه وخضروات، حبوب كاملة',
    medication: 'ليفوثيروكسين، أدوية مضادة للغدة الدرقية، اليود المشع، جراحة الغدة الدرقية، حاصرات بيتا',
    ...
    prevention: 'تأكد من كفاية اليود، تجنب الأطعمة المثيرة للدراق بكميات زائدة، اخضع لفحوصات دورية',
    ...
    advice: 'تناول أدوية الغدة الدرقية حسب الوصف، حافظ على حمية صحية، مارس الرياضة بانتظام',
    homeRemedies: 'تناول أطعمة غنية باليود مثل الأعشاب البحرية، تناول أطعمة غنية بالسيلينيوم مثل الجوز البرازيلي، مارس اليوجا',
    atRiskGroups: 'النساء، كبار السن، أصحاب التاريخ العائلي لاضطرابات الغدة الدرقية',
    alternativeTreatments: 'الاشواغاندا، مكملات السيلينيوم، الوخز بالإبر',
    references: 'الجمعية الأمريكية للغدة الدرقية (ATA)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Hypertension.png',
    lifestyle: 'تأكد من كفاية اليود، تجنب الأطعمة المثيرة للدراق، مارس الرياضة بانتظام.',
    doctorSpecialization: 'أخصائي غدد صماء',
  ),
  DiseaseInfoModel(
    disease: 'فرط نشاط الغدة الدرقية',
    description: 'فرط نشاط الغدة الدرقية حالة تنتج فيها الغدة الدرقية الكثير من هرمونات الغدة الدرقية.',
    diet: 'حمية فرط نشاط الغدة الدرقية، حمية منخفضة اليود، أطعمة غنية بالكالسيوم، أطعمة غنية بالسيلينيوم، فواكه وخضروات',
    medication: 'أقراص الجلوكوز، حلوى أو عصير، حقن الجلوكاجون، ديكستروز وريدي، دازوكسيد',
    causes: 'تسببها داء غريفز، عقيدات الغدة الدرقية، أو الإفراط في تناول اليود.',
    symptoms: 'فقدان وزن، سرعة ضربات القلب، تعرق، عصبية، رعشة',
    prevention: 'تجنب الإفراط في تناول اليود، أدر الإجهاد، اخضع لفحوصات دورية',
    diagnosis: 'فحوصات الدم، اختبارات وظائف الغدة الدرقية، اختبار امتصاص اليود المشع',
    ...
    homeRemedies: 'تناول أطعمة غنية بالكالسيوم، مارس تقنيات الاسترخاء، تجنب الكافيين',
    atRiskGroups: 'النساء، أصحاب التاريخ العائلي لاضطرابات الغدة الدرقية، أصحاب أمراض المناعة الذاتية',
    alternativeTreatments: 'البقلة، مليسة، الوخز بالإبر',
    references: 'الجمعية الأمريكية للغدة الدرقية (ATA)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Hypertension.png',
    lifestyle: 'تجنب الإفراط في تناول اليود، أدر الإجهاد، مارس الرياضة بانتظام.',
    doctorSpecialization: 'أخصائي غدد صماء',
  ),
  DiseaseInfoModel(
    disease: 'نقص سكر الدم',
    description: 'نقص سكر الدم حالة تتميز بانخفاض غير طبيعي في مستويات سكر الدم.',
    diet: 'حمية نقص سكر الدم، كربوهيدرات معقدة، وجبات خفيفة غنية بالبروتين، أطعمة غنية بالألياف، دهون صحية',
    medication: 'مسكنات الألم، تمارين، كمادات ساخنة وباردة، حماية المفاصل، علاج طبيعي',
    causes: 'تسببها الإفراط في الأنسولين، تخطي الوجبات، أو بعض الأدوية.',
    symptoms: 'رعشة، دوخة، تعرق، جوع، ارتباك',
    prevention: 'تناول وجبات منتظمة، راقب مستويات سكر الدم، تجنب الإفراط في الكحول',
    ...
    advice: 'احمل أقراص الجلوكوز، تناول وجبات صغيرة متكررة، راقب سكر الدم بانتظام',
    homeRemedies: 'تناول العسل أو عصير الفاكهة، تناول وجبات خفيفة غنية بالبروتين، تجنب الأطعمة السكرية',
    atRiskGroups: 'مرضى السكري، من يستخدمون العلاج بالأنسولين، أصحاب اضطرابات الأكل',
    alternativeTreatments: 'مكملات الكروم، مغنيسيوم، الوخز بالإبر',
    references: 'الجمعية الأمريكية للسكري (ADA)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/diabetes.png',
    lifestyle: 'تناول وجبات منتظمة، راقب مستويات سكر الدم، تجنب الإفراط في الكحول.',
    doctorSpecialization: 'أخصائي غدد صماء',
  ),
  DiseaseInfoModel(
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية التهاب المفاصل، حمية مضادة للالتهاب، أطعمة غنية بأوميجا-3، فواكه وخضروات، حبوب كاملة',
    medication: 'إعادة تأهيل دهليزي، إعادة وضع القنوات، أدوية للغثيان، جراحة، تمارين منزلية',
    causes: 'تسببها أمراض المناعة الذاتية، التهابات، أو تآكل المفاصل.',
    symptoms: 'ألم المفاصل، تورم، تيبس، احمرار، تقليل نطاق الحركة',
    prevention: 'حافظ على وزن صحي، مارس الرياضة بانتظام، تجنب إصابات المفاصل',
    diagnosis: 'فحص جسدي، فحوصات الدم، اختبارات تصويرية مثل الأشعة السينية أو الرنين المغناطيسي',
    complications: 'ألم مزمن، إعاقة، تشوهات المفاصل',
    treatmentDuration: 'إدارة طويلة المدى بالأدوية وتغييرات نمط الحياة',
    advice: 'مارس الرياضة بانتظام، حافظ على وزن صحي، تناول الأدوية حسب الوصف',
    homeRemedies: 'ضع كمادات دافئة، مارس تمارين لطيفة، استخدم الكركم',
    atRiskGroups: 'كبار السن، أصحاب الوزن الزائد، أصحاب التاريخ العائلي لالتهاب المفاصل',
    alternativeTreatments: 'مكملات الجلوكوزامين، كوندرويتين، الوخز بالإبر',
    references: 'مؤسسة التهاب المفاصل، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Arthritis.png',
    lifestyle: 'حافظ على وزن صحي، مارس الرياضة بانتظام، تجنب إصابات المفاصل.',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية الدوار، حمية قليلة الملح، ترطيب، شاي الزنجبيل، أطعمة غنية بفيتامين د',
    medication: 'علاجات موضعية، مضادات حيوية، أدوية فموية، علاجات هرمونية، آيزوتريتينوين',
    causes: 'تسببها بلورات الكالسيوم المنخلعة في الأذن الداخلية.',
    symptoms: 'دوخة، غثيان، قيء، فقدان التوازن، دوار',
    prevention: 'تجنب حركات الرأس المفاجئة، مارس تمارين التوازن، حافظ على الترطيب',
    diagnosis: 'فحص جسدي، اختبار ديكس-هولبايك، اختبارات تصويرية مثل الرنين المغناطيسي',
    complications: 'سقوط، إصابات، دوار مزمن',
    treatmentDuration: 'بضعة أسابيع مع العلاج المناسب والتمارين',
    advice: 'نفذ مناورات إعادة وضع القنوات، تجنب الحركات المفاجئة، حافظ على الترطيب',
    homeRemedies: 'مارس تمارين التوازن، اشرب شاي الزنجبيل، تناول أطعمة غنية بفيتامين د',
    atRiskGroups: 'كبار السن، أصحاب إصابات الرأس، أصحاب اضطرابات الأذن الداخلية',
    alternativeTreatments: 'جنكة بيلوبا، الوخز بالإبر، إعادة تأهيل دهليزي',
    references: 'الأكاديمية الأمريكية لطب الأنف والأذن والحنجرة (AAO-HNS)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Migraine.png',
    lifestyle: 'تجنب حركات الرأس المفاجئة، مارس تمارين التوازن، حافظ على الترطيب.',
    doctorSpecialization: 'أخصائي أنف وأذن وحنجرة',
  ),
  DiseaseInfoModel(
    disease: 'حب الشباب',
    description: 'حب الشباب حالة جلدية تحدث عندما تنسد بصيلات الشعر بالزيت وخلايا الجلد الميتة.',
    diet: 'حمية حب الشباب، حمية منخفضة المؤشر الجلايسيمي، ترطيب، فواكه وخضروات، بروبيوتيك',
    medication: 'علاجات موضعية، مضادات حيوية، أدوية فموية، علاجات هرمونية، آيزوتريتينوين',
    ...
    advice: 'اتبع روتين العناية بالبشرة، تجنب العبث بالبثور، استخدم منتجات غير كوميدوغينيك',
    ...
    references: 'الأكاديمية الأمريكية للأمراض الجلدية (AAD)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Acne.png',
    lifestyle: 'حافظ على روتين منتظم للعناية بالبشرة، تجنب مستحضرات التجميل الزيتية، أدر الإجهاد.',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية عدوى المسالك البولية، ترطيب، عصير التوت البري، بروبيوتيك، أطعمة غنية بفيتامين سي',
    medication: 'مضادات حيوية، مسكنات بولية، فينازوبيريدين، مضادات التقلص، بروبيوتيك',
    causes: 'تسببها بكتيريا تدخل إلى المسالك البولية.',
    symptoms: 'حرقان أثناء التبول، تبول متكرر، بول عكر، ألم حوضي',
    prevention: 'اشرب الكثير من الماء، حافظ على النظافة الجيدة، تبول بعد الجماع',
    diagnosis: 'فحوصات البول، زراعة البول، اختبارات تصويرية مثل الموجات فوق الصوتية',
    complications: 'عدوى الكلى، إنتان، التهابات متكررة',
    treatmentDuration: '3-7 أيام بالمضادات الحيوية المناسبة',
    advice: 'حافظ على الترطيب، تناول المضادات الحيوية حسب الوصف، تجنب المهيجات مثل الكافيين',
    ...
    references: 'الجمعية الأمريكية لطب المسالك البولية (AUA)، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/urinarytractinfection.png',
    lifestyle: 'اشرب الكثير من الماء، حافظ على النظافة الجيدة، تبول بعد الجماع.',
    doctorSpecialization: 'أخصائي مسالك بولية',
  ),
  DiseaseInfoModel(
    disease: 'الصدفية',
    description: 'الصدفية حالة جلدية مزمنة تتميز ببقع حمراء وحكة ومتقشرة.',
    diet: 'حمية الصدفية، حمية مضادة للالتهاب، أطعمة غنية بأوميجا-3، فواكه وخضروات، حبوب كاملة',
    medication: 'علاجات موضعية، علاج ضوئي، أدوية جهازية، أدوية بيولوجية، قطران الفحم',
    ...
    homeRemedies: 'ضع جل الصبار، استخدم حمامات الشوفان، تناول أطعمة غنية بأوميجا-3',
    atRiskGroups: 'أصحاب التاريخ العائلي للصدفية، أصحاب أمراض المناعة الذاتية، المدخنون',
    alternativeTreatments: 'كركم، مكملات زيت السمك، الوخز بالإبر',
    references: 'المؤسسة الوطنية للصدفية، مايو كلينك، المعاهد الوطنية للصحة (NIH)',
    image: 'assest/diease_imges/Psoriasis.png',
  ...
  DiseaseInfoModel(
    ...
    diet: 'حمية القوباء، علاج بالمضادات الحيوية، فواكه وخضروات، ترطيب، أطعمة غنية بالبروتين',
    medication: 'مضادات حيوية موضعية، مضادات حيوية فموية، مطهرات، مراهم، كمادات دافئة',
    ...
    advice: 'حافظ على المنطقة المصابة نظيفة، تجنب الحك، تناول المضادات الحيوية حسب الوصف',
    homeRemedies: 'ضع العسل، استخدم زيت شجرة الشاي، تناول أطعمة غنية بفيتامين سي',
